...
class ThreeLayerConvNet(object):
    ...
    def __init__(
        ...
        # Conv output volunme
        # conv_param is set with padding of (filter_size - 1) // 2 in the loss() function assuming the spatial size (H, W) is preserved
        H_conv = H
        W_conv = W
    ...
    def loss(self, X, y=None):
        ...
        ############################################################################
        cache1, cache2, cache3 = None, None, None
